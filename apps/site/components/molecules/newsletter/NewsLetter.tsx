      ...
      <div className="w-full">
         <div className="bg-base-100 py-8 px-9 rounded-xl">
            ...
            <p className="mt-2 text-base text-center text-base-content/60">
               Receba artigos do blog e ofertas por email
            </p>
            <form onSubmit={handleSubmit} className="mt-7">
               <div className="relative flex items-center">
                  <input
                     ...
                     disabled={loading}
                     className="px-4 py-3 border border-base-content/10 rounded-md w-full outline-none text-base-content placeholder:text-base bg-base-100 focus:border-primary transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                  />
                  <svg
                     width="18"
                     height="14"
                     ...
                     className="absolute right-4 text-base-content pointer-events-none"
                  >
                     <path
                        fillRule="evenodd"
                        clipRule="evenodd"
               ...
               <button 
                  type="submit"
                  disabled={loading}
                  className="btn btn-primary py-3 text-center font-medium w-full rounded-md mt-2 text-white text-base hover:btn-primary-focus disabled:opacity-50 disabled:cursor-not-allowed transition-all"
               >
            ...
            {error && (
               <div className="mt-3 p-3 bg-error/20 border border-error/50 rounded-md">
                  <p className="text-error text-sm text-center">{error}</p>
               </div>
            )}
            {success && (
               <div className="mt-3 p-3 bg-success/20 border border-success/50 rounded-md">
                  <p className="text-success text-sm text-center">✓ Successfully subscribed!</p>
               </div>
            )}
         </div>
      </div>
